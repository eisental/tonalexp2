...
export const second_experiment_intro = (
  <React.Fragment>
    ...
    <p>באיזו מידה מתאים הצליל המסיים את הקטע (שכונה "הדובר השני" בחלקים הקודמים של הניסוי) לשמש כהמשך למוזיקה הקודמת לו (שכונתה "הדובר הראשון" בחלקים הקודמים של הניסוי)?</p>
