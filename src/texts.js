...
export const first_experiment_intro = [
  (
    <React.Fragment>
      ...
      <p>לכל אחד מן הקטעים שתשמעו שני חלקים: בחלק הראשון כמה אקורדים (אקורד - כמה צלילים המושמעים יחד), ובחלק השני - צליל בודד. דמו ששני חלקים אלו הם שני ה"דוברים" בדיאלוג:</p>
...
export const first_experiment_training_info = (
  <React.Fragment>
    ...
    <p>אם אינכם בטוחים, תוכלו להקשיב לדיאלוג שוב (לחצו על כפתור "השמע שוב" שבתחתית המסך).</p>
