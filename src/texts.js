...
export const intro_texts = [(
  ...
  <React.Fragment>
    ...
    <p>במפגש זה שני ניסויים נפרדים. לאחר שתסיימו את הניסוי הראשון תצאו להפסקה בת עשר דקות. עם תום ההפסקה, צרו קשר עם הנסיינ/ית לקבלת הסבר. אין להתחיל בניסוי השני ללא אישור מהנסיינ/ית.</p>
